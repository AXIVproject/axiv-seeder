...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "axiv-seeder\n"
...
static const string mainnet_seeds[] = {"fs0.axiv.blockchainbuilders.net", "fs1.axiv.blockchainbuilders.net", ""};
static const string testnet_seeds[] = {"fs0.axiv.blockchainbuilders.net"};
